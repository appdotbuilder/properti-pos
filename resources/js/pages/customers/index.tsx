            ...
            <div className="p-6">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white dark:bg-gray-800 dark:divide-gray-700">
                            {customers.data.map((customer) => (
                                <tr key={customer.id}>
                                    ...
                                    <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-white">
                                        {customer.sales_transactions_count} transaksi
                                    </td>
                ...
                {customers.data.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">Belum ada konsumen</h3>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Mulai dengan menambahkan data konsumen pertama Anda.
                        </p>
                        <div className="mt-6">
                            <Link
                                href={route('customers.create')}
